	...
	<body>
	  <div id="container">
		  <header>
			...
			<form method="post" action="ProductSelection">
				<table>
					<tr>
					...
					<tr>
						<td><input style="color:white" type="submit" name="submitId" value="Add"/></td>
						<td><input style="color:white" type="submit" name="submitId" value="Delete"/></td>
					</tr>
				</table>
			</form>
			<form method="post" action="ReviewServlet">
			    <table  style="box-shadow: 0px 0px 30px red">
				    <tr>
				    	<td><input type='hidden' name='productId' value="${ requestScope.composer.getProductId() }"/></td>
				    </tr>
				    <tr>
				    	<td><input style="color:white" type="submit" name="submitId" value="Write Review"/></td>
				    	<td><input style="color:white" type="submit" name="submitId" value="View Review"/></td>
				    </tr>
			    </table>
		   </form>
		   <footer>
